...
Specify the project path: http://github.com/garymar2007/kotlin-springboot.
...
[source,bash]
$ git clone https://github.com/garymar2007/kotlin-springboot.
